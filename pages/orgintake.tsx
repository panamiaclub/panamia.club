...
const OrgIntake: NextPage = () => {
  ...
  const [communityIssue, setCommunityIssue] = useState("");
            ...
            <Grid  className={styles.formContainer}>
                ...
                >
                    ...
                    <Form style={{ width: "100%" }}>
                      ...
                      <Field name="name" required>
                          {() => (
                          <>
                          <Text className={styles.formText} style={{marginTop:"20px"}}>Name/Name of your Community/Collective/Platform/Org:</Text>
                              <Input
                              value={name}
                ...
                <Text className={styles.formText} style={{marginTop:"20px"}}>Are you looking for volunteer help?</Text>
                      ...
                      <Field name="teamSize">
                          {() => (
                          <>
                           <Text style={{marginTop:"20px"}} className={styles.formText}>How large is your organization's team?</Text>
                              <Input
                              value={teamSize}
                      ...
                      <Field name="missionStatement">
                          {() => (
                          <>
                           <Text style={{marginTop:"20px"}} className={styles.formText}>What is your vision/mission statement?</Text>
                              <Input
                              value={missionStatement}
                              onChange={(e:any) => setMissionStatement(e.target.value)}
                              placeholder={""}
                              />
                          </>
                          )}
                      ...
                      <Field name="demographic">
                          {() => (
                          <>
                           <Text style={{marginTop:"20px"}} className={styles.formText}>What demographic/community are your servicing? Be as specific as possible.</Text>
                              <Input
                              value={demographic}
                              onChange={(e:any) => setDemographic(e.target.value)}
                              placeholder={""}
                              />
                          </>
                          )}
                      ...
                      <Field name="communityEngagement">
                          {() => (
                          <>
