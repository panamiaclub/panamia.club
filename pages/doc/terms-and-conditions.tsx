  ...
  return (
    <main className={styles.app}>
      <PageMeta
        ...
        <p>We are PANA MIA CLUB, CORP, doing business as PANA MIA 
         (<strong>"Company," "we," "us," "our"</strong>), a company registered 
         in Florida, United States at 17904 SW 35th Street, Miramar FL 33029.</p>
        <p>We operate the website www.panamia.club (the <strong>"Site"</strong>),
         as well as any other related products and services that refer or link 
         to these legal terms (the <strong>"Legal Terms"</strong>) (collectively,
         the <strong>"Services"</strong>).</p>
        <p>PANA MIA CLUB is a 501c3 non-profit organizing the South Florida 
        diversified working class to build regenerative and vibrant economies. 
        By connecting locals with quality resources and educating on the benefits 
        of reinvesting locally, we cultivate financial security, personal engagement, 
        and emphasize the power of a unified community.</p>
        <p>You can contact us by email at <u>hola&#64;panamia.club</u>, or by mail to 
        17904 SW 35th Street, Miramar FL 33029, United States.</p>
        <p>These Legal Terms constitute a legally binding agreement made between 
        you, whether personally or on behalf of an entity (<strong>"you"</strong>), and 
        PANA MIA CLUB CORP, concerning your access to and use of the 
        ...
        upon posting or notifying you by hola&#64;panamia.club, as stated in the 
        email message. By continuing to use the Services after the effective 
        date of any changes, you agree to be bound by the modified terms.</p>
        <p>The Services are intended for users who are at least 18 years old. 
        ...
        <p>The information provided when using the Services is not intended for distribution
        ...
        <p>The Services are not tailored to comply with industry-specific regulations 
          ...
          to such laws, you may not use the Services. You may not use the Services in a way 
          that would violate the Gramm-Leach-Bliley Act (GLBA).</p>
        ...
        <p>If you wish to make any use of the Services, Content, or Marks other than as set out 
          in this section or elsewhere in our Legal Terms, please address your request to: 
          <u>hola&#64;panamia.club</u>. If we ever grant you the permission to post, reproduce, or publicly 
          ...
          proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
        <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
        <p>Any breach of these Intellectual Property Rights will constitute a material breach of 
        our Legal Terms and your right to use our Services will terminate immediately.</p>
        <p><strong>Your submissions and contributions</strong></p>
        <p>Please review this section and the "PROHIBITED ACTIVITIES" section carefully prior to 
          using our Services to understand the (a) rights you give us and (b) obligations you have 
          when you post or upload any content through the Services.</p>
        <p>Submissions: By directly sending us any question, comment, suggestion, idea, feedback, 
        ...
        <p>Contributions: The Services may invite you to chat, contribute to, or participate in blogs, 
          ...
          material ("Contributions"). Any Submission that is publicly posted shall also be treated 
          as a Contribution.</p>
        <p>You understand that Contributions may be viewable by other users of the Services and 
          possibly through third-party websites.</p>
        <p><strong>When you post Contributions, you grant us a license (including use of your name, 
          ...
          or otherwise, to prepare derivative works of, or incorporate into other works, your 
          Contributions, and to sublicense the licenses granted in this section. Our use and 
          distribution may occur in any media formats and through any media channels.</p>
        <p>This license includes our use of your name, company name, and franchise name, as 
          ...
          personal and commercial images you provide.</p>
        <p><strong>You are responsible for what you post or upload:</strong> By sending us Submissions
          ...
          of your social networking accounts, you:</p>
          <ul>
            ...
            <li>warrant that any such Submission and/or Contributions are original to you or that 
              ...
              rights in relation to your Submissions and/or Contributions; and</li>
        ...
        <p>You are solely responsible for your Submissions and/or Contributions and you expressly agree to 
          ...
          (b) any third party's intellectual property rights, or (c) applicable law.</p>
        <p><strong>We may remove or edit your Content:</strong> Although we have no obligation to monitor any Contributions, 
          ...
          report you to the authorities.</p>
        ...
        <p>By using the Services, you represent and warrant that: (1) all registration information you 
          ...
          a minor in the jurisdiction in which you reside; (5) you will not access the Services 
          through automated or non-human means, whether through a bot, script or otherwise; (6) 
          you will not use the Services for any illegal or unauthorized purpose; and (7) your use 
          of the Services will not violate any applicable law or regulation.</p>
        <p>If you provide any information that is untrue, inaccurate, not current, or incomplete, 
          we have the right to suspend or terminate your account and refuse any and all current or 
          future use of the Services (or any portion thereof).</p>
        ...
        <p>You may not access or use the Services for any purpose other than that for which we 
          ...
          commercial endeavors except those that are specifically endorsed or approved by us.</p>
        ...
        <ul>
          ...
          <li>Game the platform to boost your profile or search results.</li>
        </ul>

        <h3 id="user-generated-contributions">6. USER GENERATED CONTRIBUTIONS</h3>
        <p>The Services may invite you to chat, contribute to, or participate in blogs, message 
          ...
          content and materials to us or on the Services, including but not limited to text, writings, 
        ...
        <p>Any use of the Services in violation of the foregoing violates these Legal Terms and may 
          result in, among other things, termination or suspension of your rights to use the Services.</p>

        <h3 id="contribution-license">7. CONTRIBUTION LICENSE</h3>
        <p>By posting your Contributions to any part of the Services or making Contributions accessible 
          to the Services by linking your account from the Services to any of your social networking accounts, 
          ...
          excerpt (in whole or in part), and distribute such Contributions (including, without limitation, your 
          image and voice) for any purpose, commercial, advertising, or otherwise, and to prepare derivative 
          works of, or incorporate into other works, such Contributions, and grant and authorize sublicenses of the 
          foregoing. The use and distribution may occur in any media formats and through any media channels.</p>
        <p>This license will apply to any form, media, or technology now known or hereafter developed, and includes 
          ...
          your Contributions, and you warrant that moral rights have not otherwise been asserted in 
        ...
        <p>We have the right, in our sole and absolute discretion, (1) to edit, redact, or otherwise change 
          any Contributions; (2) to re-categorize any Contributions to place them in more appropriate locations 
          on the Services; and (3) to pre-screen or delete any Contributions at any time and for any reason, 
          without notice. We have no obligation to monitor your Contributions.</p>

        <h3 id="social-media">8. SOCIAL MEDIA</h3>
        <p>As part of the functionality of the Services, you may link your account with online accounts 
          ...
          Accounts may be available on and through your account on the Services. Please note that if a Third-Party 
          Account or associated service becomes unavailable or our access to such Third-Party Account is terminated 
          by the third-party service provider, then Social Network Content may no longer be available on and through 
          the Services. You will have the ability to disable the connection between your account on the Services and 
          ...
          including but not limited to, for accuracy, legality, or non-infringement, and we are not responsible 
          for any Social Network Content. You acknowledge and agree that we may access your email address book 
          associated with a Third-Party Account and your contacts list stored on your mobile device or tablet 
          computer solely for purposes of identifying and informing you of those contacts who have also registered 
          to use the Services. You can deactivate the connection between the Services and your Third-Party Account 
          by contacting us using the contact information below or through your account settings (if applicable). 
        ...
        <h3 id="third-party-websites-and-content">9. THIRD-PARTY WEBSITES AND CONTENT</h3>
        <p>The Services may contain (or you may be sent via the Site) links to other websites 
          ...
          Content are not investigated, monitored, or checked for accuracy, appropriateness, or completeness by us, 
          and we are not responsible for any Third-Party Websites accessed through the Services or any Third-Party 
          ...
          decide to leave the Services and access the Third-Party Websites or to use or install any Third-Party Content, 
          you do so at your own risk, and you should be aware these Legal Terms no longer govern. You should review 
          the applicable terms and policies, including privacy and data gathering practices, of any website to which 
          you navigate from the Services or relating to any applications you use or install from the Services. Any 
        ...
        <p>We reserve the right, but not the obligation, to: (1) monitor the Services for violations of these 
          ...
          rights and property and to facilitate the proper functioning of the Services.</p>
        ...
        <p>We care about data privacy and security. By using the Services, you agree to be bound by our 
          ...
          use of the Services, you are transferring your data to the United States, and you expressly 
          consent to have your data transferred to and processed in the United States.</p>

        <h3 id="copyright-infringements">12. COPYRIGHT INFRINGEMENTS</h3>
        <p>We respect the intellectual property rights of others. If you believe that any material available 
          ...
          to by the Services infringes your copyright, you should consider first contacting an attorney.</p>

        <h3 id="term-and-termination">13. TERM AND TERMINATION</h3>
        ...
        <h3 id="modifications-and-interruptions">14. MODIFICATIONS AND INTERRUPTIONS</h3>
        <p>We reserve the right to change, modify, or remove the contents of the Services at any time or for 
        ...
        <p>We cannot guarantee the Services will be available at all times. We may experience hardware, 
          ...
          or otherwise modify the Services at any time or for any reason without notice to you. You agree that we 
          have no liability whatsoever for any loss, damage, or inconvenience caused by your inability to access 
          or use the Services during any downtime or discontinuance of the Services. Nothing in these Legal Terms 
        ...
        <h3 id="governing-law">15. GOVERNING LAW</h3>
        <p>These Legal Terms and your use of the Services are governed by and construed in accordance with 
          the laws of the State of Florida applicable to agreements made and to be entirely performed within 
          the State of Florida, without regard to its conflict of law principles.</p>

        <h3 id="dispute-resolution">16. DISPUTE RESOLUTION</h3>
        ...
        <p>To expedite resolution and control the cost of any dispute, controversy, or claim related to these 
          Legal Terms (each a "Dispute" and collectively, the "Disputes") brought by either you or us (individually, 
        ...
        <p>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those 
          ...
          place in Palm Beach County, Florida. Except as otherwise provided herein, the Parties may litigate in 
        ...
        <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced 
          or prosecuted in the state and federal courts located in Palm Beach County, Florida, and the Parties 
          ...
          Act (UCITA) are excluded from these Legal Terms.</p>
        <p>In no event shall any Dispute brought by either Party related in any way to the Services be commenced more 
          than one (1) years after the cause of action arose. If this provision is found to be illegal or unenforceable, 
          then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to 
          be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the 
          courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of 
          that court.</p>
        <p><strong>Restrictions</strong></p>
        <p>The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. 
          ...
          purported representative capacity on behalf of the general public or any other persons.</p>
        ...
        <p>THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE 
          ...
          WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE WILL NOT BE 
          A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY 
        ...
        <h3 id="limitations-of-liability">19. LIMITATIONS OF LIABILITY</h3>
        <p>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD 
          ...
          WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER 
          OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE six (6) MONTH PERIOD PRIOR TO ANY CAUSE OF 
          ACTION ARISING OR $150.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS 
        ...
        <h3 id="user-data">21. USER DATA</h3>
        ...
        <h3 id="electronic-communications">22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
        ...
        <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance 
          ...
          at (800) 952-5210 or (916) 445-1254.</p>

        <h3 id="miscellaneous">24. MISCELLANEOUS</h3>
        <p>These Legal Terms and any policies or operating rules posted by us on the Services or in respect 
          to the Services constitute the entire agreement and understanding between you and us. Our failure 
          to exercise or enforce any right or provision of these Legal Terms shall not operate as a waiver of 
          ...
          result of these Legal Terms or use of the Services. You agree that these Legal Terms will not 
        ...
        <p><strong>PANA MIA CLUB, CORP</strong></p>
        <address>
        17904 SW 35th Street<br />
        Miramar, FL 33029<br />
        United States<br />
        </address>
        <p>hola&#64;panamia.club</p>
        <p><small>These terms of use were created using Termly's Terms and Conditions Generator.</small></p>
          </section>
