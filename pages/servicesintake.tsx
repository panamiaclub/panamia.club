                ...
                >
                  ...
                  <div id="checkbox-group" style={{color:"#EE5967", margin:"20px 0"}}>What Category does your services fall under?</div>
                      ...
                      <Field name="address" >
                          {() => (
                          <>
                           <Text className={styles.formText} style={{marginTop:"20px"}}>Address(if applicable):</Text>
                              <Input
                              value={address}
                      ...
                      <Field name="phoneNumber" >
                          {() => (
                          <>
                           <Text className={styles.formText} style={{marginTop:"20px"}}>Phone Number(if applicable):</Text>
                              <Input
                              value={phoneNumber}
