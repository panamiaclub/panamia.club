...
export default async function handler(
  ...
  const { email, name, about, backgroundEthnicity, igUsername, twitterHandle, website, logo, category, locationOptions, address, audience, tags, interest, image1, image2, image3, marketInterest, businessNeed, workshop, workshopDetails, igConsent, marketConsent, vendingConsent, collabConsent, complete, referrals } = req.body;
