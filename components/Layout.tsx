...
export default function Layout({ children }: LayoutProps) {
  ...
  const [links, setLinks] = useState([{ link: "http://panamia.club/#About", label: "About", links:null}, {link:"/links", label:"Links", links:null}, {link:"/#footer", label:"Contact Us", links:null} , {link:"/directorio", label:"El Directorio", links: null}]);//{link:"/giftguide", label:"Gift Guide", links:null}
  ...
  useEffect(() => {
    (function loop() {
      setTimeout(() => {
        if(session){
          setLinks([{ link: "http://panamia.club/#About", label: "About", links:null} , {link:"/links", label:"Links", links:null},  {link:"/#footer", label:"Contact Us", links:null}, {link:"/directorio", label:"El Directorio", links: null}, {link:"/profile", label:"Profile", links: null}]);
        }else if(!session){
          setLinks([{ link: "http://panamia.club/#About", label: "About", links:null} , {link:"/links", label:"Links", links:null},  {link:"/#footer", label:"Contact Us", links:null}, {link:"/directorio", label:"El Directorio", links: null}]);
        }
        loop();
      }, 20000);
    })();
