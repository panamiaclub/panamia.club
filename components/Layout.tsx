...
export default function Layout({ children }: LayoutProps) {
  ...
  useEffect(() => {
    (function loop() {
      setTimeout(() => {
        if(session){
          setLinks([{ link: "#Goals", label: "About", links:null} , {link:"#footer", label:"Contact Us", links:null},{link:"/directorio", label:"El Directorio", links: null}, {link:"/profile", label:"Profile", links: null}]);
        }else if(!session){
